...
public class RobotContainer {
        ...
        private final POVButton subwooferButton = new POVButton(operatorJoystick,
                        OperatorIOConstants.SUBWOOFER_POV_ANGLE); // UP
        ...
        private final JoystickButton ampButton = new JoystickButton(operatorJoystick,
                        OperatorIOConstants.AMP_BUTTON_ID);
        ...
        public RobotContainer() {
                if (Robot.isReal()) {
                        ...
                        SwerveModuleIOSparkMax frontRight = new SwerveModuleIOSparkMax(
                                        FrontRightModuleConstants.moduleID,
                                        " Front right",
                        ...
                        SwerveModuleIOSparkMax backLeft = new SwerveModuleIOSparkMax(BackLeftModuleConstants.moduleID,
                                        " Back left",
                        ...
                        driveBase = new DriveBase(new GyroIONavX(), new Vision(new VisionIOPhoton()), frontLeft,
                                        frontRight,
                                        backLeft, backRight, false);
                        pivot = new Pivot(
                                        new PivotIOSparkMax(PivotConstants.LEFT_MOTOR_ID, PivotConstants.RIGHT_MOTOR_ID,
                                                        PivotConstants.ENCODER_CHANNEL));
                        shooter = new Shooter(
                                        new ShooterIOTalonFX(ShooterConstants.UPPER_SHOOTER_ID,
                                                        ShooterConstants.LOWER_SHOOTER_ID));
                } else {
                ...
                this.autoFactory = new AutoFactory(driveBase, shooter, intake, pivot, indexer,
                                autoChooser::getResponses);
                ...
                pivot.setDefaultCommand(new RotatePivotCommand(pivot,
                                () -> pivot.getPosition().getDegrees() + -20 * MathUtil
                                                .applyDeadband(operatorJoystick
                                                                .getRawAxis(OperatorIOConstants.PIVOT_ANGLE_AXIS),
        ...
        public void configureButtonBindings() {
                alignToAmpButton
                                .whileTrue(new PeriodicConditionalCommand(
                                                new RotatePivotCommand(pivot, PivotConstants.AMP_ANGLE_SETPOINT)
                                                                .alongWith(new SpinShooterCommand(shooter,
                                                                                ShooterConstants.AMP_SPEED,
                                                                                ShooterConstants.AMP_SPEED)),
                                                autoFactory.getPathFindToPoseCommand(
                                                                FieldConstants.BLUE_ALLIANCE_AMP_POSE2D)
                                ...
                                .whileTrue(new PeriodicConditionalCommand(
                                                new RotatePivotCommand(pivot,
                                                                ...
                                                                .alongWith(new SpinShooterCommand(shooter,
                                                                                ...
                                                                                ShooterConstants.UNSHOOTER_SPEED)),
                                                autoFactory.getPathFindToPoseCommand(
                                                                FieldConstants.BLUE_ALLIANCE_SOURCE_POSE2D)
                                                                .andThen(new TurnToAngleCommand(driveBase,
                                                                                () -> FieldConstants.BLUE_ALLIANCE_SOURCE_POSE2D
                                                                                                .getRotation(),
                                                                                () -> 0,
                ...
                intakeOverrideButton.whileTrue(
                ...
                unshooterButton.whileTrue(
                                new SpinShooterCommand(shooter, ShooterConstants.UNSHOOTER_SPEED,
                                                ShooterConstants.UNSHOOTER_SPEED));
        ...
        public void smartDashSetup() {
                ...
                autoChooser.addRoutine("Characterize", List.of(
                                ...
                                new AutoQuestion<>("Which Routine",
                                                Map.of("Quasistatic Foward",
                                                                CharacterizationRoutine.QUASISTATIC_FORWARD,
                                                                "Quasistatic Backward",
                                                                CharacterizationRoutine.QUASISTATIC_BACKWARD,
                                                                "Dynamic Forward",
                                                                CharacterizationRoutine.DYNAMIC_FORWARD,
                                                                "Dynamic Backward",
                ...
                autoChooser.addRoutine("Wing And Midline Auto", List.of(
                                new AutoQuestion<>("Starting Note?",
                                                Map.of("Wing Right", 0, "Wing Center", 1, "Wing Left", 2)),
                                new AutoQuestion<>("Last Wing Note?",
                                                Map.of("-Wing Right", 0, "-Wing Center", 1, "-Wing Left", 2)),
                                new AutoQuestion<>("Starting Center Line Note?",
                                                Map.of("Midline Left", 0, "Midline Center Left", 1, "Midline Center", 2,
                                                                "Midline Center Right",
                                                                3,
                                                                "Midline Right (Source Side)", 4)),
                                new AutoQuestion<>("Starting Center Line Note?",
                                                Map.of("-Midline Left", 0, "-Midline Center Left", 1, "-Midline Center",
                                                                2,
