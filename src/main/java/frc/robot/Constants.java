...
public final class Constants {
  ...
  public static class IOConstants {
    ...
    public static class DriverIOConstants {
      ...
      public static final int ALIGN_TO_AMP_BUTTON_ID = 0;
      public static final int ALIGN_TO_SOURCE_BUTTON_ID = 0;
      public static final int ALIGN_TO_SPEAKER_BUTTON_ID = 0;
