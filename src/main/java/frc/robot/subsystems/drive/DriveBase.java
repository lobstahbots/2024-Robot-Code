...
public void driveRobotRelative(ChassisSpeeds chassisSpeeds) {
  ...
  swerveSetpoint = setpointGenerator.generateSetpoint(DriveConstants.MODULE_LIMITS, new SwerveSetpoint(chassisSpeeds, swerveSetpoint.moduleStates), discreteSpeeds, SimConstants.LOOP_TIME);
